...
namespace OzakiAnimeWPF.Data
{
    ...
    class VideoThumnail
    {
        ...
        public static async Task Main(string urlAnime)
        {
            ...
            using (var mediaPlayer = new MediaPlayer(libvlc))
            {
                ...
                // Create new media
                using var media = new Media(libvlc, new Uri(urlAnime));
                ...
                mediaPlayer.SeekTo(TimeSpan.FromMilliseconds(rnd.Next(1000, 180000)));
